...
`geofi` is not published in CRAN yet and you cant install it using `intall.packages()`. But you can install it directly from Github with  and try out the following examples.  For quick access try our Shiny app at:  [`https://muuankarski.shinyapps.io/geofi_selain/`](https://muuankarski.shinyapps.io/geofi_selain/).
