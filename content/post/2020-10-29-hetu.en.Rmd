...
Extracting age works only with a specialized function. In this example we will also introduce the ability to generate random PINs with rhetu-function:
...
[^1]: More information about sweidnumbr can be found e.g. from this blogpost: Magnusson, Mans & Bulow, Erik. 2015. R made personal (at least for swedes)!. URL: http://ropengov.org/2015/08/r-made-personal-at-least-for-swedes/
