...
Paketin asentaminen R-ympäristöön ja perustietojen tulostaminen onnistuu seuraavanlaisesti:
...
Perustietojen tarkistaminen onnistuu joko hetu-funktion extract-parametrin avulla tai siihen erikoistuneiden funktioiden avulla:
...
Muista toiminnoista poiketen ikää ei saa suoraan määritettyä hetu-funktiota käyttämällä vaan se täytyy erikseen laskea haluamassaan aikamääreessä ja haluamanaan ajankohtana. Perusasetus on ikä vuosina kysymisajankohtana, mutta myös ikä kuukausina tai päivinä on mahdollinen. 
...
# Minkä ikäisiä hetujen omistajat olivat 1950-luvun puolivälissä?
hetu_age(example_pins, date = "1955-01-01")
```
