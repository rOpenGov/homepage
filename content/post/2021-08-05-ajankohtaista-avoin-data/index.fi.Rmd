...
# Ostolaskudatan avaamisen edistyminen Varsinais-Suomessa
...
Julkaisuvuosi <- c(2015, 2018, 2021, rep("2021 (kesken)", times = 3), 2022, 2022, rep("Selvitystyö käynnistetty", times = 4), rep("Ei valmistelussa", times = 2), "Kielteinen päätös")
data_frame <- cbind.data.frame(Kunta, Julkaisuvuosi)
# names(data_frame) <- c("Kunta", "Julkaisuvuosi")

data_frame %>% 
  kbl(caption = "Varsinais-Suomen kuntien ostolaskujen julkaisuvuosi / odotettu julkaisuvuosi") %>% 
