...
Aika ajoin on hyödyllistä koostaa yhteen paikkaan uutisia ajankohtaisista kotimaisista ja ulkomaisista datan avaamiseen liittyvistä kehityskuluista. 
...
Vuonna 2021 [monet kunnat ovat edelleen vasta avaamassa ostolaskudataansa](https://www.yrittajat.fi/varsinais-suomen-yrittajat/a/uutiset/651506-yha-useampi-kunta-avaamassa-ostolaskudatansa-varsinais-suomessa). Ainoastaan [Lieto](https://lieto.fi/hallinto-ja-osallistuminen/talous-ja-strategiat/avoin-data/), [Paimio](http://www.paimio.fi/paatoksenteko/talous/ostolaskut) ja [Kaarina](https://kaarina.fi/fi/talous-ja-hankinnat/kaarinan-kaupungin-ostolaskut) ovat kirjoitushetkellä julkaisseet ostolaskunsa. Alla olevassa taulukossa esitetään, mistä lähtien dataa on ollut saatavilla tai milloin kuntien ostolaskudatan voidaan tämän hetkisten tietojen perusteella odottaa tulevan julkiseksi:

``` {r, echo = FALSE}
library(kableExtra)
Kunta <- c("Lieto", "Paimio", "Kaarina", "Turku", "Loimaa", "Masku", "Salo", "Uusikaupunki", "Raisio", "Parainen", "Mynämäki", "Kemiönsaari", "Laitila", "Kustavi", "Nousiainen")
Julkaisuvuosi <- c(2015, 2018, 2021, rep("2021 (kesken)", times = 3), 2022, 2022, rep("Selvitystyö käynnistetty", times = 4), rep("Ei valmistelussa", times = 2), "Ei julkaista")
...
Tämä listaus ei ole missään nimessä tyhjentävä. Toisaalta kirjoituksen tarkoitus ei ollut toisintaa [Open Source Observatoryn](https://joinup.ec.europa.eu/collection/open-source-observatory-osor) tai vastaavien sivustojen uutistulvaa suomen kielellä vaan poimia note-to-self -tyylisesti joitakin mielenkiintoisia kehityskulkuja, jotka saattavat vaikuttaa rOpenGovin paketteihin ja toimintaan tulevaisuudessa.

Kommenteissa voi mielellään jakaa listalta pois jääneitä uutisia, jotka olisivat teidän mielestänne tänne kuuluneet.